...
class MetricsCollector:
    ...
    def collect_metrics(
        ...
        if duration and gen_data is not None:
    ...
    def visualize_metrics(
        ...
        if (
            ...
            if orig_stats and gen_stats and "min" in orig_stats and "min" in gen_stats:
                ...
                for i, stat in enumerate(stats_keys):
                    combined_data[f"Original - {stat}"] = orig_stats_values[i]
                    combined_data[f"Generated - {stat}"] = gen_stats_values[i]
        ...
        # Visualize null distribution using create_pie_chart
        if (
            "original_data" in metrics
