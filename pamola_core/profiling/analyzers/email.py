...
Key Features:
  ...
  - Efficient chunked and parallel processing for large datasets
...
class EmailOperation(FieldOperation):
    ...
    def execute(
        ...
        **kwargs : dict
        ...
        try:
            ...
            if progress_tracker:
                progress_tracker.update(
                    total_steps, {"step": "Analysis complete", "field": self.field_name}
                )
            ...
            if progress_tracker:
                current_steps += 1
                progress_tracker.update(
                    current_steps, {"step": "Saved analysis results"}
                )
            ...
            if (
                ...
                if progress_tracker:
                    current_steps += 1
                    progress_tracker.update(
                        current_steps, {"step": "Generating visualization"}
                    )
                ...
                if progress_tracker:
                    progress_tracker.update(
                        current_steps, {"step": "Created visualization"}
                    )
            ...
            if progress_tracker:
                current_steps += 1
                progress_tracker.update(
                    current_steps, {"step": "Created domain dictionary"}
                )
    ...
    def _create_visualizations(
        ...
        **kwargs,
        ...
        operation_timestamp : Optional[str], default=None
        ...
        **kwargs
        ...
        try:
            ...
            viz_filename = (
                f"{self.field_name}_domains_distribution_{operation_timestamp}.png"
            )
