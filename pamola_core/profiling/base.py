...
- **Categorical profiling**: Identifying distributions, mode, entropy.  
- **Anomaly detection**: Finding outliers, inconsistencies.  
- **Data formatting**: Validating data structure and type consistency.  
- **Grouping analysis**: Detecting clusters or similar data patterns.  
- **Named Entity Recognition (NER)**: Identifying sensitive textual entities.  
- **Value profiling**: Measuring uniqueness, frequency, and completeness.  
...
class BaseProfilingProcessor(ABC):
    """
