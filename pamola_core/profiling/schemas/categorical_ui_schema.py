...
----------------------------------------------------
Module:        Categorical Profiler UI Schema
...
Description:
UI metadata schema for Formily-based form rendering of categorical profiling configurations in PAMOLA.CORE.
...
Changelog:
1.0.0 - 2025-01-15 - Initial creation of categorical profiler UI schema
"""
...
class CategoricalOperationUIConfig(OperationConfig):
    """
    UI configuration schema for CategoricalOperation form rendering.
    ...
    schema = {
        "type": "object",
        "title": "Categorical Operation UI Configuration",
        "description": "UI schema for categorical profiling operation configuration.",
        "allOf": [
