...
----------------------------------------------------
Module:        Currency Profiler UI Schema
...
Description:
UI metadata schema for Formily-based form rendering of currency profiling configurations in PAMOLA.CORE.
...
UI Component Types:
- Select: Dropdown menus for locale selection
- NumberPicker: Numeric inputs with validation
- Checkbox: Boolean toggles

Changelog:
1.0.0 - 2025-01-15 - Initial creation of currency profiler UI schema
"""
...
class CurrencyOperationUIConfig(OperationConfig):
    """
    UI configuration schema for CurrencyOperation form rendering.
    ...
    schema = {
        "type": "object",
        "title": "Currency Operation UI Configuration",
        "description": "UI schema for currency profiling operation configuration.",
        "allOf": [
