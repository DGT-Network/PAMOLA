...
from pamola_core.common.enum.numeric_generalization_methods import NumericGeneralizationMethod
...
class NumericGeneralizationProcessor(BaseGeneralizationProcessor, ABC):
    ...
    def __init__(
        ...
        method: str = NumericGeneralizationMethod.BINNING.value,
    ...
    def generalize(self, data: pd.DataFrame, **kwargs) -> pd.DataFrame:
        ...
        **kwargs : Dict, optional
        ...
        for column in target_fields:
            ...
            if method == NumericGeneralizationMethod.BINNING.value:
                data = self.bin_values(data, column, **kwargs)
            elif method == NumericGeneralizationMethod.ROUNDING.value:
                data = self.round_values(data, column, **kwargs)
            elif method == NumericGeneralizationMethod.SCALING.value:
