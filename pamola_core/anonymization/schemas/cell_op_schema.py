...
class CellSuppressionConfig(OperationConfig):
    ...
    schema = {
        ...
        "allOf": [
            BaseOperationConfig.schema,  # merge all common base fields
            {
                ...
                "properties": {
                    ...
                    "group_by_field": {
                        ...
                        "x-depend-on": {"suppression_strategy": ["group_mean", "group_mode"]},
                        "x-required-on": {"suppression_strategy": ["group_mean", "group_mode"]}
                    },
                    "min_group_size": {
                        "type": "number",
                        "minimum": 1,
                    ...
                    "condition_operator": {
                        ...
                        "x-depend-on": {"suppress_if": "null", "condition_field": "not_null"}
                    },
                    "condition_values": {
                        "type": ["array", "null"],
                        ...
                        "x-depend-on": {"suppress_if": "null", "condition_field": "not_null", "condition_operator": "not_null"}
                    },
                },
            ...
            {
                "if": {
                    "properties": {"suppression_strategy": {"enum": ["group_mean", "group_mode"]}}
                },
