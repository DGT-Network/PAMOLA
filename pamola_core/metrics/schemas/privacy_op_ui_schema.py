...
Module:        Privacy Metric UI Schema
...
Description:
UI metadata schema for Formily-based form rendering of privacy metric operation
...
class PrivacyMetricUIConfig(OperationConfig):
    """
    UI configuration schema for PrivacyMetricOperation form rendering.
    ...
    schema = {
        "type": "object",
        "title": "Privacy Metric Operation UI Configuration",
        "description": "UI schema for privacy metric operation configuration.",
        "allOf": [
