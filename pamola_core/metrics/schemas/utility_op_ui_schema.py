...
Module:        Utility Metric UI Schema
...
Description:
UI metadata schema for Formily-based form rendering of utility metric operation
...
class UtilityMetricUIConfig(OperationConfig):
    """
    UI configuration schema for UtilityMetricOperation form rendering.
    ...
    schema = {
        "type": "object",
        "title": "Utility Metric Operation UI Configuration",
        "description": "UI schema for utility metric operation configuration.",
        "allOf": [
