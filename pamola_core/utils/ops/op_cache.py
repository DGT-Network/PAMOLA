"""
Operation caching module for the HHR project.
...
class OperationCache:
    ...
    def __init__(self, cache_dir: Optional[Union[str, Path]] = None,
        ...
        cache_dir : str or Path, optional
            Directory to store cache files. If None, uses {user_home}/.hhrcache
        max_age_days : float
        ...
        if cache_dir is None:
            ...
            cache_dir = Path(home_dir) / ".hhrcache"
        else:
    ...
    def save_cache(self, data: Dict[str, Any], cache_key: str,
        ...
        try:
            ...
            # Save to cache
            write_json(cache_data, cache_file)
